class PaymentsController < ApplicationController
  ...
  def create
    ...
    raise Errors::InvalidPaymentRequest, payment_response[:error] if payment_response[:error]
    ...
    raise Errors::InvalidPaymentRequest, confirm_payment_response[:error] if confirm_payment_response[:error]
  ...
  rescue Errors::InvalidPaymentRequest => e
    flash[:error] = e.message
    redirect_to product_path(@product)
  end
